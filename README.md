...
9. [Polar Rate Matching](Essential_Modules_5G_PHY/Polar_Rate_Matching.md)  
10. [LDPC Rate Matching](Essential_Modules_5G_PHY/LDPC_Rate_Matching.md)  
11. [LBRM: Limited Buffer Rate Matching](Essential_Modules_5G_PHY/LBRM_Limited_Buffer_Rate_Matching.md)  
12. [RV: Redundancy Version and Bit Selection](Essential_Modules_5G_PHY/RV_Redundancy_Version_and_Bit_Selection.md)  
13. [Bit Interleaving in LDPC Rate Matching](Essential_Modules_5G_PHY/Bit_Interleaving_in_LDPC_Rate_Matching.md)  
14. [m-sequence & PN sequence](Essential_Modules_5G_PHY/m_sequence_PN_sequence.md)  
15. [Zadoff-Chu Sequence](Essential_Modules_5G_PHY/Zadoff_Chu_Sequence.md)  
16. [Scrambling](Essential_Modules_5G_PHY/Scrambling.md)  
17. [Modulation Techniques](Essential_Modules_5G_PHY/Modulation_Techniques.md)  
18. [OFDM Modulation](Essential_Modules_5G_PHY/OFDM_Modulation.md)  

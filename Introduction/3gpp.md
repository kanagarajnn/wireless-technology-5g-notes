...
The **Telecommunications Standards Development Society, India (TSDSI)** is India’s official **standards body for telecommunications**, recognized by the Indian government.

### Key Facts
- **Formed:** January 2014
- **Type:** Not-for-profit, autonomous, membership-based organization
- **Headquarters:** New Delhi, India
- **Recognized by:**
  - **Department of Telecommunications (DoT), Government of India**
  - **ITU (International Telecommunication Union)**
  - **3GPP (as an organizational partner)**

### Purpose & Goals
1. **Develop telecom standards** suited to **Indian needs**, such as rural connectivity, affordability, and infrastructure challenges.
2. **Represent India** in global standardization forums like **3GPP**, **ITU**, **oneM2M**, etc.
3. Promote **Indian innovations** in global standards.
4. Encourage the development of **indigenous telecom technologies**.

### Major Contributions
- Proposed **Low Mobility Large Cell (LMLC)** configuration for **rural 5G**, which was accepted into the **ITU-R IMT-2020** standards.
- Actively contributes to **5G**, **IoT**, **M2M**, **Smart Cities**, and **Spectrum-related policies**.

### Members
Includes stakeholders from:
- Academia (IITs, IISc, etc.)
- Industry (e.g., Reliance Jio, Bharti Airtel, Tejas Networks)
- Government bodies (like C-DOT)
- Global companies (e.g., Ericsson, Nokia, Qualcomm)
